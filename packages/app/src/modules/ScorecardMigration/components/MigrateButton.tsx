...
interface MigrateButtonProps {
	...
	onProgressUpdate: Dispatch<SetStateAction<Record<string, "SUCCESS" | "EXISTS" | "FAILED">>>;
	onClearSelection: () => void;
}

export function MigrateButton({ scorecards, selected, onProgressUpdate, onClearSelection }: MigrateButtonProps) {
