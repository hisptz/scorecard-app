...
import { generateLegendDefaults, Help, HIGHLIGHTED_INDICATOR_HELP_STEPS, ScorecardConfigEditState, ScorecardIndicator } from "@scorecard/shared";
...
export default function HighlightedIndicatorsScorecardForm() {
	...
	const onAdd = useCallback(
		(dataSources: any) => {
			const legendDefaults = generateLegendDefaults(
				legendDefinitions,
				100,
				true,
			);
