...
function getSelectedType(specificTargets: any, specificTargetsSet: any) {
...
export default function TargetsArea({ path }: any) {
				...
				<div className="column gap-16">
					<SingleSelectField
						...
						onChange={({ selected }: any) => {
							...
							setValue(
								`${path}.legends`,
								generateLegendDefaults(legendDefinitions, weight, highIsGood),
							);
