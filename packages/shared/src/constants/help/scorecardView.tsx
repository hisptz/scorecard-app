...
export const SCORECARD_VIEW_HELP_STEPS = [
	...
	},
	{
		...
		intro: (
			<div>
				<p style={{ margin: 2 }}>
					{i18n.t("Click on a data cell to see further analysis")}
				</p>
				<br />
				<p style={{ margin: 2 }}>
					{i18n.t(
						"You can also right click to view the cell data in different options",
					)}
				</p>
			</div>
		),
	...
	{
		element:
			'[data-test="orgUnit-children-table-column-cell"] > td:nth-child(1)',
		intro: i18n.t(
