...
export default function RelatedIndicatorTable(props: any) {
	...
	const { loading, error, data, refetch } = useDataQuery<any>(query, {
		variables: { id },
	});
	...
	return (
		<div>
			<p>
				{" "}
				{i18n.t(
					"Below are set of indicators using this {{variables}} as numerator or denominator in their calculations.",
