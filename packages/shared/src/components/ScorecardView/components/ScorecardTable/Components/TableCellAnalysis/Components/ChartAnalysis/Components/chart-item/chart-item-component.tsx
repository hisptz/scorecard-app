...
export default function ChartItemComponent({ chartHeight }: any) {
	const chartTypes = useRecoilValue(chartTypesAtom);
	const setChartUpdate = useSetRecoilState(chartUpdateAtom);
	const [currentChartType, setCurrentChartType] = useRecoilState(
		currentChartTypeAtom,
	);
	...
	function drawChart(analyticsObject: any, chartConfiguration: any) {
