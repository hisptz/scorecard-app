...
import {
	displayType,
	getAllId,
} from "../../../../Utils/Functions/FunctionDictionary";
...
export default function DataSource({ json }: any) {
	...
	return (
		<div>
			...
			<p>
				{i18n.t(
					"Function have rules calculating from multiple data sources. Here are few data sources observed",
				)}
			</p>
