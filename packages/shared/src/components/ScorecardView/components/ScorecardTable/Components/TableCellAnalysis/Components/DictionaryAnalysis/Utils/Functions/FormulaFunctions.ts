...
async function getValueDataElementSourceWithCombo(
	engine: any,
	id: any,
	idCombo: any,
) {
...
async function getValueProgramDataElementWithSource(
	engine: any,
	idProgram: any,
	idDataElement: any,
) {
...
export function getFormulaInWordsFromFullSources(
	formula: any,
	arrOfSources: any,
) {
...
export function getFinalWordFormula(
	formula: any,
	dataElementsArray: any,
	programIndicatorArray: any,
	dataSetReportingRatesArray: any,
	attributes: any,
	constants: any,
...
export function lowerCaseAllWordsExceptFirstLetters(string: string) {
	return string?.replace(/\S*/g, function(word: any) {
...
export function isPureDataElement(str: string) {
