...
export default function ScorecardLegendsView() {
	const { legend: showLegends, arrows: showArrows } = useRecoilValue(
	...
	const [specificTargetsLibraryOpen, setSpecificTargetsLibraryOpen] = useState(
		false,
	);
