            ...
            <div className='row center' >
                    <div className='info-box'>
                        <div className='column'>
                            <h2 className='info-box-title'>{i18n.t('Configure Data Sources')}</h2>
    ...
    return(
        <div className='col-12' style={{height: '100%' }}>
            <div className='row center align-items-center' >
                <div className='info-box'>
                    <div className='column'>
                        <p style={{fontSize: 18, color: colors.grey600, fontWeight: 'bold'}} >{i18n.t('Select a data source to configure')}</p>
                    </div>
                </div>
            </div>
        </div>
