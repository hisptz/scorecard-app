...
export default function CustomLinkedCell({top, bottom, orgUnit, period }) {
    ...
    getLegend(topValue, topLegends, {max: topWeight, specificTargets: topSpecificTargets, orgUnit, period, legendDefinitions }) ?? {};
    const {color: bottomColor} =
    getLegend(bottomValue, bottomLegends, {max: bottomWeight, specificTargets: bottomSpecificTargets, orgUnit, period, legendDefinitions}) ?? {};
