      ...
      <ul>
        <li>
          ...
          {lowerCaseAllWordsExceptFirstLetters(
            data?.sources?.valueType
          )?.replace(/_/g, " ")}{" "}
          {i18n.t("to enforce validation")}{" "}
        </li>
        <li>
          {i18n.t("Has")} {data?.expressionMatch?.validationRules?.length}{" "}
          {i18n.t("related validation rules")}
        </li>
        <li>
          {i18n.t("Part of numerators of")}{" "}
          {data?.numeratorMatch?.indicators?.length} {i18n.t("indicators")}
        </li>
        <li>
          {i18n.t("Part of denominators of")}{" "}
          {data?.denominatorMatch?.indicators?.length} {i18n.t("indicators")}
        </li>
      </ul>
    </div>
  );
