    ...
    useEffect(() => {
        function sortDataSources() {
            ...
            if (!isEmpty(dataSourceSort)) {
                setDataSources(prevDataSources => {
                    return sortDataSourcesBasedOnData({dataSort: dataSourceSort, dataSources: prevDataSources})
                })
            } else {
                setDataSources(prevDataSources => {
                    return sortDataSourcesBasedOnNames({sort: sortDataSources, dataSources: prevDataSources})
                })
            }
        }
        if(sort){
