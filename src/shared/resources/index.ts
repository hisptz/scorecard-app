...
export { default as Column } from "./icons/column.png";
export { default as Line } from "./icons/line.png";
export { default as Pie } from "./icons/pie.png";
export { default as Dotted } from "./icons/dotted.png";
export { default as Gauge } from "./icons/gauge.png";
