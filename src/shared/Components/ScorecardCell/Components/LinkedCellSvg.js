...
export default function LinkedCellSvg({
    ...
    return (
        <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} style={{display: 'block'}}>
            ...
            <text id={'test-cell-selector'}  lengthAdjust="spacingAndGlyphs" textLength={topValue?.length > 4 ? 28 : null} fontSize={topFontSize}
            ...
            <text id={'test-cell-selector'}  lengthAdjust="spacingAndGlyphs" textLength={bottomValue?.length > 4 ? 28 : null}
