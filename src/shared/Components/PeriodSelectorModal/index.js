...
import {Button, ButtonStrip, Modal, ModalActions, ModalContent, ModalTitle, TransferOption} from "@dhis2/ui";
                ...
                <div className='row center align-items-center' >
                    {
                        calendar === CalendarTypes.ETHIOPIAN ?
                            <EthiopianPeriodDimension onSelect={onPeriodSelect} selectedPeriods={value?.periods ?? []}/> :
