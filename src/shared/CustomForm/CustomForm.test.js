...
const MockComponent = ({fields, onSubmit}) =>{
    ...
    return(
        <div>
            ...
            <Button  primary onClick={()=>formRef.current.requestSubmit()} >Submit</Button>
        </div>
    )
}
...
describe('Custom Form Tests', () => {
    ...
    it('Mounts With correct fields', () => {
        ...
        mount(<CustomForm fields={fields} formReference={formRef} onSubmit={console.log}/>)
    ...
    it("Submits correct values", ()=>{
        ...
        cy.get('[data-test="legend-definition-text-LegendDefinition"]').type('Legend definition')
