	...
	return (
		...
		>
			...
			<div style={{ textAlign: "center" }}>
				<h1 style={{ margin: 4, fontSize: "2rem" }}>
					{i18n.t("Welcome to the scorecard plugin")}
				</h1>
				<span>
					{i18n.t(
						"It seems you do not have any scorecards configured. Create a scorecard first in the Interactive scorecard app first."
					)}
				</span>
			</div>
			<Button
