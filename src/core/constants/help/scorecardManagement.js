...
export const INDICATOR_CONFIGURATION_STEPS = [
    ...
    },
    {
        ...
        intro: <div>
            ...
            <p>
                <b>{i18n.t("Display Arrows")}:</b>{i18n.t("Check this to display increasing/decreasing arrows on this indicator's value")}
            </p>
            <p>
                <b>{i18n.t("High is Good")}:</b>{i18n.t("Check this to indicate that higher values are good for this indicator  ")}
            </p>
            <p><b>{i18n.t("Show Colors")}:</b>{i18n.t("Check this to enable legend color on an indicator value ")}</p>
        </div>
...
export const HIGHLIGHTED_INDICATOR_HELP_STEPS = [
    {
        intro: <div>
            ...
            <p>
                {
                    i18n.t("In this page you can add and configure highlighted indicators. These indicators appear on top of the scorecard table")
                }
            </p>
        </div>
    },
...
export const ACCESS_HELP_STEPS = [
    {
        intro: <div>
            ...
            <p>
                {
                    i18n.t("In this page you can configure the default organisation unit and sharing access")
                }
            </p>
        </div>
    },
...
export const OPTIONS_HELP_STEPS = [
    {
        intro: <div>
            ...
            <p>{i18n.t("In this page you can set default options for the scorecard view")}</p>
        </div>
    },
    {
        ...
        intro: <div>
            ...
            <p>
                <b>{i18n.t("Legend")}:</b>{i18n.t("Allows the legends on the scorecard header to be displayed when checked")}
            </p>
            <p>
                <b>{i18n.t("Title")}:</b>{i18n.t("Allows the title on the scorecard header to be displayed when checked")}
            </p>
            <p>
                <b>{i18n.t("Item Number")}:</b>{i18n.t("Allows row numbers on the scorecard to be displayed when checked")}
            </p>
            <p>
                <b>{i18n.t("Empty Rows")}:</b>{i18n.t("Allows the empty rows on the scorecard to be displayed when checked")}
            </p>
            <p>
                <b>{i18n.t("Show Hierarchy")}:</b>{i18n.t("Allows the organisation units hierarchy to be displayed when checked")}
            </p>
            <p><b>{i18n.t("Average Column")}:</b>{i18n.t("Allows the average column to be displayed when checked")}</p>
            <p><b>{i18n.t("Average Row")}:</b>{i18n.t("Allows the average row to be displayed when checked")}</p>
            <p>
                <b>{i18n.t("Highlighted Indicators")}:</b>{i18n.t("Allows the highlighted indicators to be displayed when checked")}
            </p>
        </div>
    },
    {
        ...
        intro: <div>
            ...
            <p><b>{i18n.t("All")}:</b>{i18n.t("Allows all data to be displayed")}</p>
            <p>
                <b>{i18n.t("Below Average")}:</b>{i18n.t("Allows data that is below the overall average to be displayed")}
            </p>
            <p>
                <b>{i18n.t("Above Average")}:</b>{i18n.t("Allows data that is above the overall average to be displayed")}
            </p>
        </div>
    },
    {
        ...
        intro: <div>
            ...
            <p>
                <b>{i18n.t("Arrows")}:</b>{i18n.t("Allows increasing or decreasing indicators on data cells to be displayed")}
            </p>
            <p>
                <b>{i18n.t("Show Data in Rows")}:</b>{i18n.t("Changes the table layout, the indicators are shown in rows and orgaunisation units in columns")}
            </p>
        </div>
    }
]
