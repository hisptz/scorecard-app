...
Then(
  ...
  () => {
    ...
    cy.readFile(path.join(downloadsFolder, "Test Scorecard.xlsx")).should(
      "exist"
    );
  }
);
...
Then(
  ...
  () => {
    const downloadsFolder = Cypress.config("downloadsFolder");
    cy.readFile(path.join(downloadsFolder, "Test Scorecard.csv")).should(
      "exist"
    );
  }
);
...
Then(
  ...
  () => {
    const downloadsFolder = Cypress.config("downloadsFolder");
    cy.readFile(path.join(downloadsFolder, "Test Scorecard.json")).should(
      "exist"
    );
  }
);
...
Then(
  ...
  () => {
    const downloadsFolder = Cypress.config("downloadsFolder");
    cy.readFile(
      path.join(downloadsFolder, "Test Scorecard-metadata.json")
    ).should("exist");
  }
);
