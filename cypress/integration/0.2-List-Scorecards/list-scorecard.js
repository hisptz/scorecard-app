...
When("opening a list of many scorecards", () => {
    ...
    cy.intercept("GET", "/api/" + apiVersion + "/dataStore/hisptz-scorecard/scorecard-summary", {
...
When("opening a list where there are no available scorecards", () => {
    ...
    cy.intercept("GET", Cypress.env("dhis2BaseUrl") + "/api/35/dataStore/hisptz-scorecard/scorecard-summary", {
        fixture: "",
    });
});
